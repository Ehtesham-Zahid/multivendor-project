...
//   return (
//     <div className="col-span-1 rounded-md  bg-white p-3 shadow-xl shadow-zinc-300   relative hover:shadow-2xl hover:shadow-zinc-400 w-48 h-48 ">
...
const SearchCard = ({ product }) => {
  ...
  return (
    <div className="  bg-white pl-1   shadow-zinc-300   relative  w-full border-b border-dark py-1 hover:bg-sky-50 cursor-pointer">
      <Link
      ...
      >
        ...
        <div className="flex flex-col justify-around   ">
          <p className="text-md font-bold text-sky-800 hover:underline underline-offset-[2px] decoration-1  cursor-pointer">
            {product?.name}
          </p>
