...
export const CATEGORIES = [
  { name: "Clothing & Shoes", image: CategoryImage1 },
  { name: "Mobile & Electronics", image: CategoryImage2 },
  { name: "Pet Food", image: CategoryImage9 },
  { name: "Home & Kitchen", image: CategoryImage3 },
  { name: "Beauty & Personal Care", image: CategoryImage4 },
  { name: "Grocery & Food", image: CategoryImage5 },
  { name: "Health & Fitness", image: CategoryImage6 },
  { name: "Books & Stationery", image: CategoryImage7 },
  { name: "Toy & Baby Items", image: CategoryImage8 },
  { name: "Others", image: CategoryImage10 },
];
