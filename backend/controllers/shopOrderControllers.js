...
//   if (deliveryStatus === "cancelled" && shopOrder.paymentStatus !== "paid") {
//     shopOrder.deliveryStatus = "cancelled";
//     await shopOrder.save();
//   }
...
//     shopOrder.refundStatus !== "refunded"
//   ) {
//     // shopOrder.paymentStatus = "cancelled";
//     const admin = await User.findOne({ role: "admin" });
//     if (!admin) {
//       res.status(500);
//       throw new Error("Admin user not found");
...
//   if (allCancelled && parentOrder.deliveryStatus !== "cancelled") {
